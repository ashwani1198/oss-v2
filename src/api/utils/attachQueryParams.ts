...
export const MemberQuerySchema = z.object({
  ...
  order_by: z.enum(['first_name','last_name','address','status','membership_type','general_body_meeting_date']).default('first_name'),
...
export const attachQueryParams = (url: string, params: MemberQueryParams): string => {
  ...
  if (params.general_body_meeting_date) url += mergeStr(GENERAL_BODY_MEETING_DATE, params.general_body_meeting_date);
